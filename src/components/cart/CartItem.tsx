...
export default function CartItem({ bundleId, quantity, locale, bundle }: CartItemProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 py-6 border-b border-gray-100 last:border-b-0">
      ...
      <div className="w-16 h-16 rounded-[--radius-md] flex items-center justify-center text-2xl shrink-0 bg-gradient-to-br from-teal-pale to-lavender-pale">
        {bundle.emoji}
      </div>
